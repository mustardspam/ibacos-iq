-- 1. Drop outdated or duplicate policies
...
-- 4. Rebuild RLS policies using the safe function
...
-- (Optional) Allow authenticated users to view neighborhoods
